...
DATE: 6/15/2024
PURPOSE: Snake game part 12 (welcome screen and cheatcodes)
"""
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Kristal Snakes Game",black,screen_width//4.5,screen_height//2.5)
        text_screen("Press \"space\" to play",black,screen_width//4.5,screen_height//2.0)
